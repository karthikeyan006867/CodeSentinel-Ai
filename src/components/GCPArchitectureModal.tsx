...
export const GCPArchitectureModal: React.FC<GCPArchitectureModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-md p-3 sm:p-6 flex justify-center items-start animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl rounded-2xl bg-[#0d1322] border border-slate-700/80 shadow-2xl p-5 sm:p-6 space-y-6 my-2 sm:my-8 animate-in zoom-in-95 duration-200">
        {/* Modal Header */}
